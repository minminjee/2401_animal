...
public class ApiDog {
	...
	//유기동물 사진 API
	@RequestMapping(value="animalPhotoAPI", method=RequestMethod.GET)
	public String photo() throws IOException {
		StringBuilder urlBuilder = new StringBuilder("http://openapi.seoul.go.kr:8088"); /*URL*/
		urlBuilder.append("/" +  URLEncoder.encode("644661616c6469653433584357644c","UTF-8") ); /*인증키 (sample사용시에는 호출시 제한됩니다.)*/
	...
	//유기동물 정보 API
	//															한글깨짐 해결
	@RequestMapping(value="animalInfoAPI", method=RequestMethod.GET, produces="application/test; charset=UTF-8")
